...
DEFAULT_TABLE = [
    ...
    [-5.00, -4.00, -2.67,  0.00, 13.20, 26.40, 39.60, 52.80, 66.00],  # 12 m/s
    [-5.00, -4.00, -2.67,  0.00, 14.80, 29.60, 44.40, 59.20, 74.00],  # 20 m/s
    [-5.00, -4.00, -2.67,  0.00, 16.40, 32.80, 49.20, 65.60, 82.00],  # 30 m/s
    [-5.00, -4.00, -2.67,  0.00, 18.00, 36.00, 54.00, 72.00, 90.00],  # 40 m/s
]
